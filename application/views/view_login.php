...
<html lang="en">
<head>
	<link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/img/favicon_fix.png">
	<title>ITSRent | Login</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url(); ?>login/login_validation"  method="post">
					<span class="login100-form-title p-b-43"><br><br><br>
						<!-- <img class="rounded-float-left img-responsive" style="width:100px;height:100px;background-color:#F7F7F7"> -->
					</span>
          ...
          <?php if ($this->session->flashdata('error_status')): ?>
            ...
            <span class="text-danger"><?php echo form_error('password'); ?></span>
                  ...
                  <select class="form-control" name="role">
				  	<option name="role" value="role" disabled selected>Select Role</option>
				...
				<div class="login100-more" style="background-image: url(<?php echo base_url(); ?>assets/img/Loginan.png)">
				</div>
			</div>
		</div>
	</div>
